...
UNIVERSAL_SCHEMA = {
    ...
    "loan_status": ["payment_status", "loan_state", "load_status"],
    ...
    "ltv_ratio": ["loan_to_value", "ltv_pct", "ltv"],
    ...
    "shipment_id": ["pronumber", "bolnumber", "trackingnumber", "loadid", "sid", "referencenumber", "docketnumber"],
    ...
    "oee_score": ["overall_equipment_effectiveness", "utilization_pct"],
    ...
    "clv": ["customer_lifetime_value", "lifetime_value"],
