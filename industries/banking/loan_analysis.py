...
def calc_loan_metrics(df):
    ...
    conf, warns = evaluate_kpi_confidence(df, [loan_status_col, outstanding_col])
    ...
    if "Default" in status_dist.index or "defaulted" in df[loan_status_col].str.lower().unique():
