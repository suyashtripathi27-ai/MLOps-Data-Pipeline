...
def calc_energy_metrics(df):
    ...
    energy_col = first_column(df, ["energy_kwh", "power_consumption_kwh", "electricity_kwh"])
    intensity_col = first_column(df, ["energy_intensity", "kwh_per_unit"])
    gas_col = first_column(df, ["gas_usage", "gas_consumption", "steam_usage"])
